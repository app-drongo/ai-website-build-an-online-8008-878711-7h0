        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Your wellness journey starts with
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Premium health supplements, natural remedies, and wellness products delivered to your
              door. Expert pharmacist guidance included.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              >
                <ShieldCheck className="mr-2 size-5" /> Our Quality Promise
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  src="https://images.unsplash.com/photo-1576602976047-174e57a47881?q=80&w=1920&auto=format&fit=crop"
                  alt="Natural health supplements and wellness products"
                  fill
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">2,500+</span> wellness items
              </p>
            </div>
          </div>
        </div>
